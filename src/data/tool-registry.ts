...
export const toolRegistry: readonly ToolDefinition[] = [
  {
    ...
    description: 'Convert JPG, PNG, and WebP images in your browser, with clearly labeled browser-dependent inputs.',
    shortDescription: 'Convert between JPG, PNG, and WebP.',
    category: 'image-tools',
    status: 'public',
    lastModified: '2026-07-04',
    related: ['image-compressor', 'image-resizer', 'image-cropper', 'background-remover', 'qr-generator'],
  ...
  },
  {
    ...
    description: 'Re-encode or resize images and compare the actual result; smaller output is not guaranteed.',
    shortDescription: 'Reduce quality or dimensions and inspect the result.',
    category: 'image-tools',
    status: 'public',
    lastModified: '2026-07-04',
    related: ['image-converter', 'image-resizer', 'image-cropper', 'background-remover', 'qr-generator'],
  ...
  },
  {
    ...
    description: 'Resize images to custom dimensions or verified platform presets while controlling aspect ratio.',
    shortDescription: 'Resize images to custom or platform dimensions.',
    category: 'image-tools',
    status: 'public',
    lastModified: '2026-07-04',
    related: ['image-cropper', 'image-compressor', 'image-converter', 'background-remover', 'qr-generator'],
  ...
  },
  {
    ...
    status: 'public',
    lastModified: '2026-07-04',
    related: ['image-resizer', 'image-converter', 'image-compressor', 'image-to-pdf', 'background-remover'],
  ...
  },
  {
    ...
    description: 'Remove one image background locally after downloading the browser AI model and runtime.',
    shortDescription: 'Remove image backgrounds with a local browser model.',
    category: 'image-tools',
    status: 'public',
    lastModified: '2026-07-04',
    related: ['image-cropper', 'image-resizer', 'image-compressor', 'image-converter', 'qr-generator'],
    variants: [],
  },
  {
    id: 'image-to-pdf',
    ...
    description: 'Combine ordered JPG, PNG, or WebP images into a PDF with page size, orientation, and margin controls.',
    shortDescription: 'Combine images into a configurable PDF.',
    category: 'create-export',
    status: 'public',
    lastModified: '2026-07-04',
    related: ['image-converter', 'image-compressor', 'image-cropper', 'image-resizer', 'favicon-generator'],
  ...
  },
  {
    ...
    status: 'public',
    lastModified: '2026-07-04',
    related: ['image-resizer', 'image-cropper', 'image-converter', 'image-compressor', 'image-to-pdf'],
  ...
  },
  {
    ...
    description: 'Create PNG or SVG QR codes for text, URLs, WiFi, and vCards with contrast-aware downloads.',
    shortDescription: 'Create customizable PNG or SVG QR codes.',
    category: 'create-export',
    status: 'public',
    lastModified: '2026-07-04',
    related: ['favicon-generator', 'image-to-pdf', 'image-converter', 'image-resizer', 'background-remover'],
    variants: [],
  },
] as const;
