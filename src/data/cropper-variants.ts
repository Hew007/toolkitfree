  ...
  'crop-to-square': {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'A square image has equal width and height (1:1 ratio). Common sizes include 1080×1080 (Instagram), 500×500 (Facebook), and 400×400 (LinkedIn).',
      },
      {
      ...
      },
      {
        ...
        answer:
          'The crop tool lets you select the area to keep. The output size depends on how large you make the crop area. For specific pixel dimensions, use our Image Resizer after cropping.',
      },
    ],
  },
  'crop-to-16-9': {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '16:9 is the standard widescreen ratio used for YouTube thumbnails (1280×720), HD video, presentations, and most modern displays.',
      },
      {
        question: 'Will the image quality change after cropping?',
        answer:
          'The selected area keeps its pixel dimensions, then the browser re-encodes it. PNG is lossless for the cropped pixels; JPG and WebP may change quality according to the selected setting.',
      },
    ],
  },
  'crop-to-4-3': {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '4:3 is the traditional screen ratio used in presentations (PowerPoint defaults), older monitors, iPads, and many digital cameras.',
      },
      {
        question: 'Can I crop multiple images to 4:3?',
        answer:
          'Currently the tool processes one image at a time. Upload and crop each image individually for the best results.',
      },
    ],
  },
  'crop-to-3-2': {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '3:2 is the native ratio of most DSLR and mirrorless cameras. It is also standard for 4×6 inch photo prints.',
      },
      {
        question: 'Why use 3:2?',
        answer:
          '3:2 matches the native sensor ratio of most cameras, so cropping to this ratio preserves the original composition intent. It is also the ratio for standard photo prints.',
      },
    ],
  },
  'free-crop': {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'The crop tool shows you the current selection size in pixels. Drag the handles to get your desired dimensions. For exact pixel control, use our Image Resizer after cropping.',
      },
      {
        question: 'Does cropping reduce image quality?',
        answer:
          'The crop keeps the selected pixel dimensions, but the result is re-encoded. Choose PNG for lossless cropped pixels or adjust JPG/WebP quality to balance size and detail.',
      },
      {
        question: 'What image formats can I crop?',
        answer:
          'The cropper accepts JPG, PNG, and WebP images. The output can be saved as PNG, JPG, or WebP.',
      },
    ],
  },
};
