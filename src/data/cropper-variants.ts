...
export const variantData: Record<string, CropperVariantPageData> = {
  ...
  'crop-to-16-9': {
    ...
    faq: [
      ...
      { question: 'Will the image quality change after cropping?', answer: 'The selected area keeps its pixel dimensions, then the browser re-encodes it. PNG is lossless for the cropped pixels; JPG and WebP may change quality according to the selected setting.' },
    ],
  },
  'crop-to-4-3': {
  ...
  'free-crop': {
    ...
    faq: [
      ...
      { question: 'Does cropping reduce image quality?', answer: 'The crop keeps the selected pixel dimensions, but the result is re-encoded. Choose PNG for lossless cropped pixels or adjust JPG/WebP quality to balance size and detail.' },
      { question: 'What image formats can I crop?', answer: 'The cropper accepts JPG, PNG, and WebP images. The output can be saved as PNG, JPG, or WebP.' },
    ],
  },
};
